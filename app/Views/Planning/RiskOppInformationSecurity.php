            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-submenu">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#" onclick="confirm_Alert('ต้องการที่จะ Pending Reviewed หรือไม่', 'context/status_update/<?= $data_is['id_version'] ?>/1')">Pending
                            Review</a>
                ...
                <div class="dropdown-submenu">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#" onclick="confirm_Alert('Would you like to confirm the update review date?', 'context/update_date/<?= $data_is['id_version'] ?>/1')">Update
                            review date</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#" onclick="confirm_Alert('ต้องการที่จะ Copy ข้อมูลหรือไม่', 'context/copydata/<?= $data_is['id_version'] ?>')">Revise</a>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-3 ">
                    <h6>Approved Date:
                        <span class="gray-text">
                            <?php echo $data_is['approved_date']; ?>
                        </span>
                    </h6>
                </div>
            </div>
            <div class="row justify-content-center mb-2">
                <div class="col-sm-3 ">
                    <h6>Modified Date:
                        <span class="gray-text">
                            <?php echo $data_is['modified_date']; ?>
                        </span>
                    </h6>
                </div>
                <div class="col-sm-3 ">
                ...
                <div class="col-sm-3 ">
                    <h6>Announce Date:
                        <span class="gray-text">
                            <?php echo $data_is['announce_date']; ?>
                        </span>
                    </h6>
                </div>
            </div>
...
<div class="card" id="information-security-ana">
    <div class="card-body">
                ...
                <div class="form-group">
                    <ul class="nav nav-pills" id="tabs-tab" role="tablist">
                        <li class="nav-item-tab" style="padding-right: 10px;">
                            <a class="nav-link active" id="risk-information-security-tab" data-toggle="pill" href="#risk-information-security" role="tab" aria-controls="risk-information-security" aria-selected="true">Risk</a>
                        </li>
                        <li class="nav-item-tab">
                            <a class="nav-link" id="opportunity-information-security-tab" data-toggle="pill" href="#opportunity-information-security" role="tab" aria-controls="opportunity-information-security" aria-selected="false">Opportunity</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="risk-information-security" role="tabpanel" aria-labelledby="org-strategy-tab">
            ...
            <div class="tab-pane table-wrapper fade show" id="opportunity-information-security" role="tabpanel" aria-labelledby="opportunity-information-security-tab">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        selectElement.addEventListener('change', function(e) {
            ...
            if (selectedValue === 'full-table-is') {
                console.log('check full-table-is');
                fullTable.style.display = 'block';
                shortTable.style.display = 'none';
            } else if (selectedValue === 'short-table-is') {
                console.log('check short-table-is');
