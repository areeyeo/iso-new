                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= site_url('/competenec'); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Competence</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url(''); ?>" class="nav-link">
                                <i class="fas fa-cogs fa-lg nav-icon"></i>
                                <p>
                                    Operation
                                    <i class="right fas fa-angle-right"></i>
                                </p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= site_url('/performance_evaluation'); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="<?= site_url('/management_review'); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
