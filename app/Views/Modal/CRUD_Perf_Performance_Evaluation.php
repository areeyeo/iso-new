            ...
            <div class="row">
                <div class="col-4 p-4" style="background-color: #E2F0FF;">
                    <div class="form-group">
                        ...
                        <div class="mb-3" style=" color: #0062FF; font-size: 16pt;" name="obj_no_detail" id="obj_no_detail">&nbsp;&nbsp;&nbsp;OBJ_001</div>
                    </div>
                    <div class="form-group">
                        <div style=" color: #0062FF; font-size: 13pt;">Objective</div>
                        <div style=" color: #666666; font-size: 11pt;" class="mb-3" name="objective" id="objective">short sentence examples</div>
                    </div>
                    <div class="form-group">
                        <div style=" color: #0062FF; font-size: 13pt;">Evaluation</div>
                        <div style=" color: #666666; font-size: 11pt;" class="mb-3" name="evaluation" id="evaluation">short sentence examples</div>
                    </div>
                </div>
                <div class="col-8">
                    <div class="p-3">
                        <div class="form-group">
                            ...
                            <div style=" color: #666666; font-size: 11pt;" class="mb-3" name="planning" id="planning">short sentence examples</div>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div style=" color: #666666; font-size: 11pt;" class="mb-3" name="who_detail" id="who_detail">short sentence examples</div>
                        </div>
                        <div class="form-group mt-3">
