                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <!-- <button type="button" class="btn btn-outline-dark btn-sm">Save Draft</button>
                                <button type="button" class="btn btn-outline-primary btn-sm">Send Review</button>
                                <button type="button" class="btn btn-outline-success btn-sm">Send Approval</button>
                                <button type="button" class="btn btn-danger btn-sm">Rejected</button>
                                <button type="button" class="btn btn-outline-danger btn-sm">View Rejection Details</button>
                                <button type="button" class="btn btn-success btn-sm">Approved</button>
                                <button type="button" class="btn btn-warning btn-sm">Request Modification</button>
                                <button type="button" class="btn btn-outline-warning btn-sm">View Request Details</button> -->
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-end align-items-baseline">
                            ...
                            <span class="badge rounded-pill" style="background-color: #343A40; color: #fff;">Draft</span>
                            <span class="badge rounded-pill" style="background-color: #D40000; color: #fff;">Rejected</span>
                            <span class="badge rounded-pill" style="background-color: #D4EDDA; color: #28A745;">Pending Review</span>
                            <span class="badge rounded-pill" style="background-color: #E2F0FF; color: #0062FF;">Pending Approval</span>
                            <span class="badge rounded-pill" style="background-color: #28A745; color: #fff;">Approved</span>
                            <span class="badge rounded-pill" style="background-color: #FBCB0A; color: #fff;">Request Modification</span>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
